  ...
  Future<void> _signIn() async {
    ...
    try {
      final response = await http.post(
        ...
        body: json.encode({'id': _idController.text, 'name': _nameController.text}),
      );
...
CustomSnackBar.show(context, message: 'Login successful', type: SnackBarType.success);
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => DashboardScreen(token: _authToken!, role: _userRole!),
          ),
        );
      } else {
        setState(() {
